...
class ApiRouter {
  ...
  init() {
    ...
    this.router.post('/items/batch/quickmatch-covers', LibraryItemController.batchQuickMatchCovers.bind(this))
    ...
    this.router.get('/authors/:id/other-libraries', AuthorController.middleware.bind(this), AuthorController.getOtherLibraries.bind(this))

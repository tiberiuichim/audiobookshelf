<template>
  <div class="w-full flex flex-col relative z-40">
    ...
    <div v-if="isAuthorsPage" class="hidden md:flex h-10 bg-bg2 border-t border-b border-fg/10 items-center px-8">
      ...
      <ui-btn v-if="userCanUpdate && !isBatchSelecting" :loading="processingAuthors" color="bg-primary" small class="ml-2 h-7.5" @click="matchAllAuthors">{{ $strings.ButtonMatchAllAuthors }}</ui-btn>
